...
if [ -e "$ADLAIRE_DESIGN_ROOT/UI/compat-agws.css" ]; then
  echo "Adlaire-Design must not contain UI/compat-agws.css because product-specific compatibility layers are out of scope." >&2
  exit 1
fi
